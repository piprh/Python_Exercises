...
#Get DNA sequence again in GenBank format for annotation details
subprocess.call("esearch -db nucleotide -query \"AJ223353\"  | efetch -format gb > DNA.gb", shell=True)
